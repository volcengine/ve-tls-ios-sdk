...
@interface VeExecutor ()

@property (nonatomic, copy) void(^block)(void(^block)(void));

@end

@implementation VeExecutor

#pragma mark - Executor methods

+ (instancetype)defaultExecutor {
    static VeExecutor *defaultExecutor = NULL;
...
+ (instancetype)immediateExecutor {
    static VeExecutor *immediateExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
+ (instancetype)mainThreadExecutor {
    static VeExecutor *mainThreadExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
