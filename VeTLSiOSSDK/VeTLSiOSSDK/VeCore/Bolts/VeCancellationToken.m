...
@interface VeCancellationTokenRegistration (VeCancellationToken)
...
@implementation VeCancellationToken
...
- (void)notifyCancellation:(NSArray *)registrations {
    for (VeCancellationTokenRegistration *registration in registrations) {
...
- (VeCancellationTokenRegistration *)registerCancellationObserverWithBlock:(VeCancellationBlock)block {
    @synchronized(self.lock) {
        VeCancellationTokenRegistration *registration = [VeCancellationTokenRegistration registrationWithToken:self delegate:[block copy]];
